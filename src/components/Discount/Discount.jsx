...
const Discount = () => {
  return (
   <section className='bg-zinnc-100 bg-no-repeat bg-right bg-contain' style={{backgroundImage:`url(${FreshFruits})`}}>
...
<div className='max-w-[700px]' >
    ...
    <p className='text-zinc-600 my-6'> njoy an exclusive first order discount on our grocery website! Shop fresh essentials and save big on your first purchase. Fast delivery and quality guaranteed.</p>
